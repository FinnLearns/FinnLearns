...
<pre><code class="language-py">for (double b = betaLower; b <= betaUpper; b+= betaStep)
...
<pre><code class="language-py">void Ising::updateLattice(double currentBeta, int rand1, double rand2)
{
